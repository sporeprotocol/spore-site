...
const Card: React.FC<CardProps> = ({length, index, img, title, listItems, link }) => {
    return (
        <div className="w-[520px] sm:w-full relative cursor-pointer group">
            ...
            <div className="relative w-[520px] h-[616px] sm:w-full sm:h-[510px] border-4 bg-BackgroundLight rounded-3xl border-BrandBlack py-8 px-12 sm:px-4 sm:py-8 shadow-lg flex flex-col gap-8">
