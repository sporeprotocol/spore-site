    ...
    return (
        <div className={styles.SporeGuideWrapper}>
            ...
            <div className={styles.SporeGuideContainer}>
                <SporeGuideItem SvgIcon={BlueSvg} title={'Spore demo'} content={'Designed to help you build transactions, encode and decode data, and develop applications simple and efficient'} url={'https://github.com/sporeprotocol/spore-sdk'}/>
